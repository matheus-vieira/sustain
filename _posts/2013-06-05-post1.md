...
<p>This is just an <em>ipsis verbis</em> copy of the first example running on the <a href="https://demo.ghost.io">Ghost Demo</a>. This shows how you can use html styling to achieve your hopes.</p>
...
<input type="image" src="https://placekitten.com/90/24" alt="Image (input)">  
...
<div><input type="image" src="https://placekitten.com/90/24" alt="Image (input)"></div>  
